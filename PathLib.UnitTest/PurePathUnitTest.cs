...
namespace PathLib.UnitTest
{
    public class PurePathUnitTest
    {
        ...
        public void Compare_WindowsFormat_ParentDirectory_IsParentOf_ChildDirectory_ShouldBeTrue()
        {
            ...
            Assert.True(IsParentOf(parentPurePath, childPurePath));
        }

        private bool IsParentOf(IPurePath parent, IPurePath child)
        {
            return child.ToString().StartsWith(parent.ToString()) && child.ToString().Length > parent.ToString().Length;
        }
        ...
        public void Compare_WindowsFormat_ChildDirectory_IsChildOf_ParentDirectory_ShouldBeTrue()
        {
            ...
            Assert.True(IsChildOf(childPurePath, parentPurePath));
        }

        private bool IsChildOf(IPurePath child, IPurePath parent)
        {
        ...
        public void Compare_WindowsFormat_DifferentDrives_ChildDirectory_IsChildOf_ParentDirectory_ShouldBeFalse()
        {
            ...
            Assert.False(IsChildOf(childPurePath, parentPurePath));
        }
